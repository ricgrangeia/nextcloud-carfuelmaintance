...
/** @template-extends QBMapper<MaintenanceEntry> */
class MaintenanceEntryMapper extends QBMapper {
	public function __construct(IDBConnection $db) {
		parent::__construct($db, 'cfm_maintenance_entries', MaintenanceEntry::class);
	}
	 ...
	 */
	public function find(int $id): MaintenanceEntry {
