...
/** @template-extends QBMapper<FuelEntry> */
class FuelEntryMapper extends QBMapper {
	public function __construct(IDBConnection $db) {
		parent::__construct($db, 'cfm_fuel_entries', FuelEntry::class);
	}
	 ...
	 */
	public function find(int $id): FuelEntry {
